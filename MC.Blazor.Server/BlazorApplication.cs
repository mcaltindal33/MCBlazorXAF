...
using MC.Blazor.Server.Services;

namespace MC.Blazor.Server {
    public partial class MCBlazorApplication : BlazorApplication {
        public MCBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void MCBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
