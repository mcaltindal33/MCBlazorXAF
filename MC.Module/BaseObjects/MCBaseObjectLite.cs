...
namespace MC.Module.BaseObjects
{
    ...
    public abstract class MCBaseObjectLite : XPLiteObject
    {
        protected MCBaseObjectLite() : base() { }
        protected MCBaseObjectLite(Session session) : base(session) { }
        protected MCBaseObjectLite(Session session, XPClassInfo classInfo) : base(session, classInfo) { }

        static MCBaseObjectLite()
        {
